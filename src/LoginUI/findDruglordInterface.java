...
public class findDruglordInterface {
	...
	public findDruglordInterface(final Connection con,final String user){
		...
		mainFrame = new JFrame("Druglord Find Druglord View");
		...
		JLabel addictView = new JLabel ("Find Druglord");
		...
		// find by name Label
		JLabel nameLabel = new JLabel("Find druglord with name: ");
		...
		JLabel cashGreaterLabel = new JLabel("Find druglord with cash >: ");
		c.gridwidth = GridBagConstraints.RELATIVE;
		c.insets = new Insets(10, 10, 5, 0);
		...
		// find by cashGreater Label
		JLabel cashLesserLabel = new JLabel("Find druglord with cash <: ");
		c.gridwidth = GridBagConstraints.RELATIVE;
		c.insets = new Insets(10, 10, 5, 0);
		...
		JLabel cocaineGreaterLabel = new JLabel("Find druglord with cocaine >: ");
		c.gridwidth = GridBagConstraints.RELATIVE;
		c.insets = new Insets(10, 10, 5, 0);
		...
		JLabel cocaineLesserLabel = new JLabel("Find druglord with cocaine <: ");
		c.gridwidth = GridBagConstraints.RELATIVE;
		c.insets = new Insets(10, 10, 5, 0);
		...
		searchByNameButton.addActionListener(new ActionListener(){
			...
			private void showSearchResult(String name) {
				JFrame dataFrame = new JFrame("Find Druglord");
				JPanel contentPane = new JPanel();
				...
				try {
					List<DrugLordData> drugLordData = DataQueries.findDruglordsByName(name);
					for (DrugLordData d : drugLordData) {
		...
		searchByCashGreaterButton.addActionListener(new ActionListener(){
			...
			private void showSearchResult(String cashGreater) {
				...
				try {
					List<DrugLordData> drugLordData = DataQueries.findDruglordsByCashGreater(cashGreater);
					for (DrugLordData d : drugLordData) {
						Object[] o = new Object[3];
						o[0] = d.name;
						o[1] = d.cash;
		...
		searchByCashLesserButton.addActionListener(new ActionListener(){
			...
			private void showSearchResult(String cashLesser) {
				...
				try {
					List<DrugLordData> drugLordData = DataQueries.findDruglordsByCashLesser(cashLesser);
					for (DrugLordData d : drugLordData) {
						Object[] o = new Object[3];
						o[0] = d.name;
						o[1] = d.cash;
		...
		searchByCocaineGreaterButton.addActionListener(new ActionListener(){
			...
			private void showSearchResult(String cocaineGreater) {
				...
				try {
					List<DrugLordData> drugLordData = DataQueries.findDruglordsByCocaineGreater(cocaineGreater);
					for (DrugLordData d : drugLordData) {
						Object[] o = new Object[3];
						o[0] = d.name;
						o[1] = d.cash;
		...
		searchByCocaineLesserButton.addActionListener(new ActionListener(){
			...
			private void showSearchResult(String cocaineLesser) {
				...
				try {
					List<DrugLordData> drugLordData = DataQueries.findDruglordsByCocaineLesser(cocaineLesser);
					for (DrugLordData d : drugLordData) {
						Object[] o = new Object[3];
						o[0] = d.name;
						o[1] = d.cash;
